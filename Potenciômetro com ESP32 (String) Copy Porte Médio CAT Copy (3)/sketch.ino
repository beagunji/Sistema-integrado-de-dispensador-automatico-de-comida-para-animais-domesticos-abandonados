...
const String TopicoPrefixo = "TESTGRUPO5CAT"; // Topic prefix
...
void enviarDados() {
  ...
  float peso = (valorSensor * 73.5) / 4095;
...
//CAT
//Porte médio (de 5.18 kg)
//o ideal é oferecer entre 73.5 g de ração por dia. 
//2 refeições = 73.5 / 2 = 36.75
